...
public class CommitteeController {
    ...
    public ResponseEntity<Page<CommitteeDto>> getByConferenceId(@PathVariable Long conferenceId, Pageable pageable) {
        Page<CommitteeDto> committees = ICommitteeService.getByConferenceId(conferenceId, pageable);
        return ResponseEntity.ok(committees);
    }
    ...
    public ResponseEntity<Page<CommitteeDto>> getByConferenceIdAndType(
            ...
            Pageable pageable) {
        Page<CommitteeDto> committees = ICommitteeService.getByConferenceIdAndType(conferenceId, committeeType, pageable);
        return ResponseEntity.ok(committees);
    }
}
